...
class BSE:
    def __init__(self,model,Tval,fileG,nkfine):
        self.model = model
        self.Tval = Tval
        self.fileG = fileG
        self.readData()
...
###################################################################################
Ts = [1, 0.75, 0.5, 0.4, 0.3, 0.2, 0.15, 0.125, 0.1, 0.09, 0.08, 0.07, 0.06, 0.05, 0.04, 0.035, 0.03, 0.025, 0.02, 0.01]
#Ts = [0.4]
