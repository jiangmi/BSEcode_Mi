...
folder = '../Nc'+str(Nc)+'/ep'+str(epx)+'_'+str(epy)+'/d'+str(d)
folder = '.'
...
for T_ind, T in enumerate(Ts):
    ...
    for v in Nv:
        for q in qs:
            ...
            file_tp = folder+'/T='+str(Ts[T_ind])+'/dca_tp_mag_q'+str(q)+'.hdf5'
            file_tp = folder+'/T='+str(Ts[T_ind])+'/dca_tp.hdf5'
            #file_tp = './T='+str(Ts[T_ind])+'/dca_tp_mag_qpipi_iw'+str(v)+'.hdf5'
            file_sp = folder+'/T='+str(Ts[T_ind])+'/dca_sp.hdf5'
